...
class BoxingNews::Scraper
    doc = Nokogiri::HTML(open("https://www.espn.com.au/boxing/"))
        ...
        story.author = doc.search("div.contentItem__contentMeta.contentItem__contentMeta--bottom span.contentMeta__author").text
        story.timestamp = "Less than a week ago" if @timestamp == nil
        story.timestamp = doc.search("div.contentItem__contentMeta.contentItem__contentMeta--bottom span.contentMeta__timestamp").text
        ...
        # author timestamp <div class="contentItem__contentMeta contentItem__contentMeta--bottom"><span class="contentMeta__timestamp">23h</span><span class="contentMeta__author">Timothy Bradley Jr.</span></div>
end

BoxingNews::Scraper.new.scrape_espn_headline